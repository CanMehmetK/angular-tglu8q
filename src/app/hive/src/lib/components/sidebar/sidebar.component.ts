...
export class HiveSidebarComponent implements OnInit, OnDestroy {
  ...
  private _appConfig: IHiveConfig;
  ...
  ngOnInit(): void {
    ...
    this._hiveSidebarService.register(this.name, this);
  ...
  ngOnDestroy(): void {
    ...
    this._hiveSidebarService.unregister(this.name);
  ...
  private _setupLockedOpen(): void {
    ...
    this._hiveMatchMediaService.onMediaChange
      .pipe(takeUntil(this._unsubscribeAll))
      .subscribe(() => {
